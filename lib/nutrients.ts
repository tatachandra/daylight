...
export const OTHER:NutrientSpec[]=[{id:'energy',name:'Energy',unit:'kcal'},{id:'1004',name:'Fat',unit:'g'},{id:'1005',name:'Carbohydrate',unit:'g'},{id:'1087',name:'Calcium',unit:'mg'},{id:'1089',name:'Iron',unit:'mg'},{id:'1092',name:'Potassium',unit:'mg'},{id:'1093',name:'Sodium',unit:'mg'},{id:'1095',name:'Zinc',unit:'mg'}];
